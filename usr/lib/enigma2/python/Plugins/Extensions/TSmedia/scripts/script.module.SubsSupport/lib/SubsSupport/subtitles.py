...
from Plugins.Extensions.TSmedia.lib.pltools import trace_error,logdata,removeunicode,removeColorCode
from . import _, __author__, __version__, __email__
log_file='/tmp/TSmedia/subsupport.log' 
def printE(msg=''):
...
def getImdb_id():
    try:
     tmbd_id=open("/tmp/TSmedia/imdb_id").read()
     return tmbd_id
    except:
      trace_error()  
      return None  
...
class SubsMenu(Screen):
    ...
    def showMediaLists(self):
            from Plugins.Extensions.TSmedia.screens.imdbTools import imdbAPI
            from Plugins.Extensions.TSmedia.lib.pltools import getMediaShortName
    ...
    def getSupportedSubids(self,imdb_id=''):
        ...
        if imdb_id:
            from Plugins.Extensions.TSmedia.lib.subsapi import getSupportedSub_ids
    ...
    def getRelatedSubFiles(self,srURL,srTtitle):
                ...
                srtFiles +=findPattarn(".srt","/media/hdd/TSmedia/subtitles/",srTtitle)
    ...
    def ok(self):
        ...
        if mode == 'choose':
            ...
            self.cancel()
             ...
             if imdb_id:
                from Plugins.Extensions.TSmedia.lib.subsapi import getmovie_sub 
...
class SubsSearchParamsMenu(Screen, ConfigListScreen):
    ...
    def getNewVK(self):
        if self["config"].getCurrent()[1] == self.searchSettings.title: 
            ...
            self["configActions"].setEnabled(True)
            self.currentList = self.LIST_CONFIG
        from Plugins.Extensions.TSmedia.lib.NewVirtualKeyBoard import VirtualKeyBoard
