...
from iTools import printDBG, printExc,printD,printE#, IsExecutable
from iTools import common, CParsingHelper
from iTools import TranslateTXT as _
from iTools import decorateUrl
#from Plugins.Extensions.IPTVPlayer.libs.urlparserhelper import getDirectM3U8Playlist, getMPDLinksWithMeta
from iTools import strwithmeta
#from Plugins.Extensions.IPTVPlayer.libs.e2ijson import loads as json_loads
from iTools import ph
...
###################################################
ytformat        =  "mp4"#, choices = [("flv, mp4", "flv, mp4"),("flv", "flv"),("mp4", "mp4")]) 
ytDefaultformat = "720"#, choices = [("0", _("the worst")), ("144", "144p"), ("240", "240p"), ("360", "360p"),("720", "720p"), ("1080", "1080p"), ("1440", "1440p"), ("2160", "2160p"), ("9999", _("the best"))])
ytUseDF         = True
ytVP9           = False
ytShowDash      = 'auto'#ConfigSelection(default = "auto", choices = [("auto", _("Auto")),("true", _("Yes")),("false", _("No"))])
ytSortBy        ="video_view_count"# ConfigSelection(default = "", choices = [("", _("Relevance")),("video_date_uploaded", _("Upload date")),("video_view_count", _("View count")),("video_avg_rating", _("Rating"))]) 
